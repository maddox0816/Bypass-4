...
document.body.innerHTML = "<div style='position:fixed; background:#000; pointer-events: none; z-index:9999999999; right:15px; bottom:10px; padding:5px; opacity:0.3; color:#fff; font-size:13px; font-family: \"Times New Roman\", serif; line-height: initial; width:auto;'>Powered By TMN Bypass 4.0</div>" + document.body.innerHTML;
